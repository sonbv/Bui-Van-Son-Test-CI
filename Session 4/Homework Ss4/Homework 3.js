...
console.log(x);
console.log('3.1 What is the data type of the outermost layer');
console.log('The outermost layer (x) is the object data type');
console.log("The hits property is where the job results are stored,");
console.log('hits is an array variable');
console.log("In each hit of hits, how to find the job’s title, locations, salary, benefits, skills and requirements?");
console.log("we can find these values by using loop");