// console.log('1. Get jobs data from this link, copy the whole content and assign it a variable or a constant named jobData');
let jobData = {
    hits: [
        {
            benefits: [
...
// console.log('2. Get all the job hits');
// console.log(jobData);
// console.log('3. Get the first job hit');
// console.log(jobData.hits[0]);
console.log('4. Get jobTitle of the first job hit');
...
// console.log('6. Print out ALL benefitValues of the first job hit');
...
for (let y = 0; y<jobData.hits[0].jobTitle.length;y++) {
    // let i =0; i<jobData.hits[0].benefits.length;i++) 
    console.log(jobData.hits[y].jobTitle)
    console.log('Benefits:')
    // console.log(jobData.hits[y].benefits[i].benefitValue)
    console.log('-----------------------');
}

console.log('8. Log out jobTitle, locations, skills, jobSalary and benefitValues of ALL job hits');
